...
export const metadata = {
  title: 'Why RepID exists',
};

export default function WhyPage() {
  return (
    <main className="flex-1 max-w-4xl mx-auto px-6 py-24">
      <h1 className="text-4xl md:text-5xl font-bold mb-16 text-center text-white">Why RepID exists</h1>
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700/50">
              <p className="text-gray-300 leading-relaxed text-lg">
                <strong className="text-white">If you're building AI agents:</strong> your agent's reputation is your reputation. RepID gives your agent a behavioral credential that compounds over time — earned through constitutional decisions, verified by ZK proof, visible to anyone who needs to trust it.
              </p>
            </div>
            
            <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700/50">
              <p className="text-gray-300 leading-relaxed text-lg">
                <strong className="text-white">If you're using AI agents:</strong> you deserve to know whether the agent acting on your behalf has a track record worth trusting. RepID makes that visible.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-white font-bold text-xl mb-2 flex items-center gap-3">
                <span className="text-amber-500 text-sm font-mono bg-amber-500/10 px-2 py-1 rounded">THE GRACE POOL</span>
              </h3>
            ...
            <div>
              <h3 className="text-white font-bold text-xl mb-2 flex items-center gap-3">
                <span className="text-amber-500 text-sm font-mono bg-amber-500/10 px-2 py-1 rounded">THE PYTHAGOREAN COMMA VETO</span>
              </h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div>
              <h3 className="text-white font-bold text-xl mb-2 flex items-center gap-3">
                <span className="text-amber-500 text-sm font-mono bg-amber-500/10 px-2 py-1 rounded">ZERO-KNOWLEDGE PROOF</span>
              </h3>
              <p className="text-gray-400 leading-relaxed">
                Every RepID score is cryptographically proven. Not claimed. Proven. 122 proofs on-chain. More every day.
              </p>
            </div>
          </div>
        </section>
      ...
      <div className="flex flex-col gap-6 items-center justify-center text-center">
        <h3 className="text-white font-bold text-2xl">Ready to score your agent?</h3>
